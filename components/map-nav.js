...
{/* mobile dropdown */}
        <div id="small-screen" className="flex lg:hidden flex-col xl:flex-row justify-between ">
          ...
          <div className="xl:block flex justify-between items-center">
            ...
            <div
            // onClick={showHide}
            className=" xl:hidden absolute top-96 flex mt-44 bg-white w-72 justify-center rounded-2xl px-2 py-2 ml-10 shadow-2xl">
              {/* <svg
              ...
              <Link href="/">
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className='w-10 active:bg-yellow-600 active:rounded-2xl active:py-2 active:px-2'>
