...
export default function Navbar() {
  ...
  return (
    ...
    <div id="head-nav" className="fixed bg-white text-black left-10 top-40 right-0 w-32 max-sm:top-0">
      <div >
        <div className="hidden lg:flex flex-row xl:flex-row justify-between pr-0 pl-0 ">
        ...
        {/* <div className="xl:py-6 py-5 xl:block flex justify-between items-center">
          ...
          <div style={{zIndex: "999"}} className="hidden xl:flex flex-row xl:flex-col items-center overflow-hidden font-medium tracking-wide ml-0">

          <Link href="/" className=" cursor-pointer hover:text-orange-500 font-semibold underline flex">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className='w-5 active:bg-yellow-600 active:rounded-2xl active:py-3 active:px-2'>
                   <path d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/>
                  </svg>
            Home
            </Link>

            <Link href="/features" className=" cursor-pointer hover:text-orange-500 font-semibold underline flex">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='w-5 active:bg-yellow-600 active:rounded-xl active:py-2 active:px-2'>
            ...
            <Link href="/prices" className=" cursor-pointer hover:text-orange-500 font-semibold underline flex" >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" className='w-2 active:bg-yellow-600 active:rounded-xl active:py-2 active:px-2'>
                       <path d="M48 80a48 48 0 1 1 96 0A48 48 0 1 1 48 80zM0 224c0-17.7 14.3-32 32-32H96c17.7 0 32 14.3 32 32V448h32c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H64V256H32c-17.7 0-32-14.3-32-32z"/>
                     </svg>
            About
            </Link>
            <Link href="/prices" className=" cursor-pointer hover:text-orange-500 font-semibold underline flex" >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className='w-5 active:bg-yellow-600 active:rounded-xl active:py-2 active:px-2'>
